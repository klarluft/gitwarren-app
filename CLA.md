# GitWarren Individual Contributor License Agreement
...
well as the Owner and the Project's users; it does **not** change your rights to
...
written communication sent to the Owner or the Project's representatives —
including but not limited to pull requests, issues, patches, and messages on
electronic mailing lists, source code control systems, and issue tracking systems
that are managed by or on behalf of the Owner — excluding communication that is
...
**You further grant the Owner the right to license Your Contributions, and any
derivative works of them, under any licence terms of the Owner's choosing —
including the GNU General Public License, any other free or open source licence,
and proprietary or commercial licence terms — and to sublicense these rights
through multiple tiers of sublicensees.**

This grant is what allows the Project to be offered under more than one licence
at once, and to change licence in the future without needing to locate and obtain
permission from every past contributor.
...
3. If Your employer has rights to intellectual property that You create, You
   ...
   Your employer has executed a separate Corporate CLA with the Owner.
4. Your Contributions do not, to the best of Your knowledge, violate any third
   party's copyrights, patents, trademarks, trade secrets, or other rights.
...
Signing is handled automatically. When you open your first pull request, a bot
comments with the text below; replying to that comment with it records your
signature against your GitHub account, and you will not be asked again for
...
Signatures are stored in this repository's `cla-signatures` branch. There is no
third-party service involved and no email address is collected beyond what is
already public in your git commits.

---

*This agreement is adapted from the Apache Software Foundation Individual
Contributor License Agreement v2.0, with an added explicit relicensing grant in
section 2.*
