...
/**
 * A machine of yours on the tailnet, for the Hosts screen: a real host, not
 * a mock-up. Nothing is fetched at seed time - the card connects when the
 * screen is opened, and what it shows is whatever that machine actually says.
 */
