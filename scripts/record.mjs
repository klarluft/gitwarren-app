 ...
 *
 * `webm` false skips the VP9 deliverable. `width` is the delivered width; the frames are whatever the page was
 ...
 */
export async function encode(recorder, { outDir, name, loopFade = null, poster = true, width = null, webm = true }) {
  ...
  const written = [mp4]
  // The VP9 encode is the slow half, and a clip bound for an editor rather
  // than a web page has no use for it.
  if (webm) {
